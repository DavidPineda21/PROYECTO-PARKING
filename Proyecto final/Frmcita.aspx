<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Frmcita.aspx.cs" Inherits="Proyecto_final.Frmcita" %>
          ...
          <div class="row">
            ...
            <div class="col-sm-4 offset-md-1 py-4">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="Frmmascota.aspx" class="text-white"></a></li>
                <li><a href="Frmcita.aspx" class="text-white">REGISTRO VEHICULO</a></li>
              </ul>
            </div>
          </div>
        </div>
   ...
   <div class = "container">
    <div class = "row">
                    ...
                    <fieldset class = "form-signin">
                        ...
                        <div class = "input-group mb-3">
                            ...
                            <div class = "col-md-8">
                                ...
                                <asp:CheckBox ID="SALIDA" runat="server" name = "valor" type = "text" placeholder = "Valor" class = "form-control" Width="710px" MaxLength="6" Text="SALIDA" OnCheckedChanged="SALIDA_CheckedChanged"/>
                            </div>
                                <div>
                                   <div class="input-group">
                            </div>
                 ...
                 <asp:RegularExpressionValidator ID="Revcodigo" runat="server" ErrorMessage="Solo 6 digitos" ControlToValidate="txtplaca" style="color: #0099FF; font-weight: 700" ValidationExpression="[A-Z][A-Z][A-Z][0-9][0-9][0-9|A-Z]" SetFocusOnError="True"></asp:RegularExpressionValidator>
                        ...
                        <div class = "input-group mb-3">
                         ...
                         <div class = "input-group mb-3">
                            ...
                            <div class = "col-md-8">
                                ...
                                <div class="input-group">
                                <asp:TextBox id = "txthorasalida" name = "name" type = "text" placeholder = "00:00" class = "form-control" runat="server" Width="710px" MaxLength="10" OnTextChanged="txthorasalida_TextChanged"/>
                            </div>
                            <div>
                        ...
                        <div class = "input-group mb-3">
                            ...
                            <div class = "col-md-8">
                                ...
                                <span class="input-group-btn">
                          <asp:Button class="btn btn-default" type="button" runat="server" Text="Buscar" ID="Btnbuscardos" OnClick="Btnbuscardos_Click"></asp:Button>
                           </span>
                            </div>
                             <div>
                        ...
                        <div class = "input-group mb-3">
                         ...
                         <div class = "input-group mb-3">
                            ...
                            <div class = "col-md-8">
                                ...
                                <div class="input-group">
                                <asp:TextBox id = "txtnomdueño" name = "" type = "text" placeholder = "Nombre " class = "form-control" runat="server" Width="710px" OnTextChanged="txtnomdueño_TextChanged1"/>   
                            </div>
                                </div>
                        </div>
                    ...
                    <div class = "form-group">
                            <div class = "col-md-12 offset-md-3">
                                <asp:button type = "submit" class = "btn btn-primary btn-lg" runat="server" ID="btnguardar" Text="GUARDAR" OnClick="btnguardar_Click"> </asp:button>
                                 &nbsp;<asp:button type = "submit" class = "btn btn-primary btn-lg" runat="server" ID="BtmLimpiar" Text="LIMPIAR ESPACIOS" OnClick="BtmlIMPIAR_Click"> </asp:button>
                            </div>
                        </div>
      ...
      <div class="container">
        ...
        <p>En este parqueadero tu transporte estara seguro...¡ Disfrutalo !</p>
