    ...
    public partial class Frmcita : System.Web.UI.Page
    {
        ...
        protected void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    lblm.Text = "Registro guardado. Limpia espacios si quieres Ingresar al sistema una Entrada o Salida de un vehículo.";
        ...
        protected void BtmlIMPIAR_Click(object sender, EventArgs e)
        {
            ...
            SALIDA.Enabled = true;
            txthoraentrada.Enabled = true;
            lblm.Text = "Puedes buscar otro vehiculo para tomar su Salida o Entrada.";
        }
        ...
        protected void Btnbuscaruno_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    lblm.Text = "Placa ya esta registrada. Puede registrarla ya sea para su Salida o Entrada";
