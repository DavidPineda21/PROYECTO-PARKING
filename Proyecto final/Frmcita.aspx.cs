...
namespace Proyecto_final
{
    public partial class Frmcita : System.Web.UI.Page
    {
        ...
        protected void txtnomdueño_TextChanged(object sender, EventArgs e)
        {

        }

        protected void txtnomdueño_TextChanged1(object sender, EventArgs e)
        {

        }

        protected void SALIDA_CheckedChanged(object sender, EventArgs e)
        {
